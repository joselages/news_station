...
As últimas notícias da [RTP](https://rr.sapo.pt/rss) para consultar rapidamente ou expôr no seu estabelecimento.
...
* [RSS da RTP](https://www.rtp.pt/noticias/rss/) - RSS com as últimas notícias
* [rss2json](https://rss2json.com) - conversor de XML para JSON
